...
\@x{}\moduleLeftDash\@xx{ {\MODULE} CandidateRanking}\moduleRightDash\@xx{}%
...
\@xx{}%
\@x{ Sortings ( S ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET} D \.{\defeq} 1 \.{\dotdot} Cardinality ( S )}%
\@x{\@s{16.4} \.{\IN} \{ seq \.{\in} [ D \.{\rightarrow} S ] \.{:}}%
\@x{\@s{55.46} \.{\land} S \.{\subseteq} \{ seq [ i ] \.{:} i \.{\in} D \}}%
 \@x{\@s{55.46} \.{\land} \A\, i ,\, j \.{\in} D \.{:} ( i \.{<} j )
...
\@xx{}%
\@x{ KeyLeq ( s ,\, t ) \.{\defeq}}%
\@x{\@s{16.4} s . key \.{\leq} t . key}%
\@pvspace{8.0pt}%
\@x{ GeneralSortings ( S ,\, LEQ ( \_ ,\, \_ ) ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET} D \.{\defeq} 1 \.{\dotdot} Cardinality ( S )}%
\@x{\@s{16.4} \.{\IN} \{ seq \.{\in} [ D \.{\rightarrow} S ] \.{:}}%
\@x{\@s{55.46} \.{\land} S \.{\subseteq} \{ seq [ i ] \.{:} i \.{\in} D \}}%
 \@x{\@s{55.46} \.{\land} \A\, i ,\, j \.{\in} D \.{:} ( i \.{<} j )
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{SortSet} def, this is a recursive def
}%
\@xx{}%
\@x{ {\RECURSIVE} SortSet ( \_ )}%
\@x{ SortSet ( S ) \.{\defeq}}%
\@x{\@s{36.65} {\IF} S \.{=} \{ \} \.{\THEN} {\langle} {\rangle}}%
 \@x{\@s{83.06} \.{\ELSE} \.{\LET} ss \.{\defeq} {\CHOOSE} ss \.{\in} S \.{:}
 \A\, t \.{\in} S \.{:} ss . key \.{\leq} t . key}%
 \@x{\@s{114.37} \.{\IN} {\langle} ss {\rangle} \.{\circ} SortSet ( S
 \.{\,\backslash\,} \{ ss \} )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Generic \ensuremath{SortSet} def, this is a recursive def
}%
\@xx{}%
\@x{ GeneralSortSet ( S ,\, LEQ ( \_ ,\, \_ ) ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET} {\RECURSIVE} SetToSeq ( \_ )}%
\@x{\@s{89.55} SetToSeq ( SS ) \.{\defeq}}%
\@x{\@s{97.75} {\IF} S \.{=} \{ \} \.{\THEN} {\langle} {\rangle}}%
 \@x{\@s{140.06} \.{\ELSE} \.{\LET} ss \.{\defeq} {\CHOOSE} ss \.{\in} SS
 \.{:} \A\, t \.{\in} SS \.{:} LEQ ( ss ,\, t )}%
 \@x{\@s{171.37} \.{\IN} {\langle} ss {\rangle} \.{\circ} SetToSeq ( SS
 \.{\,\backslash\,} \{ ss \} )}%
\@x{\@s{16.4} \.{\IN} SetToSeq ( S )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Aug} 20
 17:29:34 \ensuremath{PDT} 2017 by \ensuremath{junlongg
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Aug} 20 15:29:31
 \ensuremath{PDT} 2017 by \ensuremath{junlongg
}%
\end{cpar}%
\end{lcom}%
\end{document}
